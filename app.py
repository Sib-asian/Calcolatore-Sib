            ...
            if ai_agent and (team_home or team_away):
                with st.spinner("🤖 AI sta analizzando la partita..."):
                    try:
                        ...
                        analysis_prompt += f"\n## News e Informazioni\n"
                        analysis_prompt += f"- Se trovi news REALI: mostra titolo e descrizione\n"
                        analysis_prompt += f"- Se trovi infortuni REALI: lista nomi giocatori\n"
                        analysis_prompt += f"- Se NON trovi dati: scrivi 'Nessuna news/infortunio trovato'\n"
