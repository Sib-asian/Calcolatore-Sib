            ...
            if ai_agent and (team_home or team_away):
                with st.spinner("🤖 AI sta analizzando la partita..."):
                    try:
                        ...
                        analysis_prompt += f"\n## News e Informazioni (REGOLA CRITICA)\n"
                        ...
                        analysis_prompt += f"- Se 'formatted_text' contiene news/infortuni/formazioni, MOSTRALI TUTTI così come sono\n"
                        analysis_prompt += f"- Se 'formatted_text' dice 'Nessuna news trovato', scrivi esattamente quello\n"
                        analysis_prompt += f"- NON dire 'ci sono news disponibili' - DEVI MOSTRARE il contenuto di 'formatted_text'!\n"
